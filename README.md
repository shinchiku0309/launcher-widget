...
- キー選択画面内で 106 / 101 配列を切り替え可能。同時押下・順次押下のキー入力に対応
- Alt を短時間保持する専用の Alt+Tab 切替キーに対応
...
ビルドには Visual Studio 2022 Build Tools と C++ デスクトップ開発環境が必要です。
...
インストーラー作成には Inno Setup 6 が必要です。
...
- Settings 画面では、レイアウト、常に手前に表示、タスクトレイ表示、自動起動などを設定できます。
